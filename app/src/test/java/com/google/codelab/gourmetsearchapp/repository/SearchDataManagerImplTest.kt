...
class SearchDataManagerImplTest {
    ...
    companion object {
        ...
        private val aStoresBusinessModel = StoresBusinessModel(totalPages = 1, getPages = 1, store = listOf(com.google.codelab.gourmetsearchapp.model.businessmodel.Store(id = "J999999999", name = "レストラン", lat = 10.0, lng = 10.0, budget = "2000円", genre = "イタリアン", photo = "", urls = "", isFavorite = false)))
    }
